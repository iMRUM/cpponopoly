...
namespace monopoly {
    BoardView::BoardView(float width, float height): SFComposite(
        sf::Vector2f(0.f, 0.f), sf::Vector2f(width, height)) {
    ...
    void BoardView::createBottomSquares() {
    ...
    void BoardView::createLeftSquares() {
    ...
    void BoardView::createTopSquares() {
    ...
    void BoardView::createRightSquares() {
    ...
    void BoardView::createCornerSquares() {
        // GO (bottom right)
    ...
    bool BoardView::handleEvent(const sf::Event &event) {
    ...
    void BoardView::updateHouseOnStreet(int square_id) {
    }

    BoardSquareComponent *BoardView::findSquareById(int square_id) {
        for (const auto &component: children) {
            auto *square = dynamic_cast<BoardSquareComponent *>(component.get());
            if (square && square->getSquareId() == square_id) {
                return square;
            }
        }
        return nullptr;
